<template>
  <div class="map-container">
    ...
    <div class="app-menu">
      <app-menu align="rr;tb,bt">
        <template v-slot:activator="{ toggle }">
          <v-btn aria-label="Menu" class="icon" color="dark" @click="toggle">
    ...
    <transition name="collapse-width">
      <div v-show="panelVisible" class="main-panel">
        <div class="f-col">
          <MNKContent />
...
.map-container {
  ...
  grid-template-rows: 1fr minmax(0, max-content) minmax(0, min-content) minmax(
      0,
      min-content
    );
  > * {
